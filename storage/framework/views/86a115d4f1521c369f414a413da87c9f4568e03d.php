...
<body>
    <div class="flex-center position-ref full-height">
        ...
        <div class="top-right links">
            <?php if(Auth::check()): ?>
            <a href="<?php echo e(route('admin')); ?>">Admin</a> <?php else: ?>
            <a href="<?php echo e(url('/login')); ?>">Login</a>
            <a href="<?php echo e(url('/register')); ?>">Register</a> <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="content">
            ...
            <article class="post">
                <div class="post-thumb">
                    <img src="../uploads/<?php echo e($user->filename); ?>" alt="">
                </div>
                <div class="post-content">
                    <header class="entry-header text-center text-uppercase">
                        <h6>Категория: <?php echo e($user->category); ?></h6>

                        <h2 class="entry-title"><?php echo e($user->title); ?></h2>
